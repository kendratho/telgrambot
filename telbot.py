...
import string
TOKEN =os.environ.get("1159646796:AAErwIzgMCiZ546l5tgwHjGp7FzN4tD6qks ")
...
def sendMessage(chat_id, text):
    r = requests.post("https://api.telegram.org/bot{token}/sendMessage".format(token=TOKEN),data={"chat_id": chat_id, "text": text})
